...
Generated by ai-factory. Manifest: `.factory.yaml`. Profile: `python-library`.
Do not hand-edit — edit `.factory.yaml` or the profile, then re-run `factory install`.

## Repo identity

- **Name:** auteur-ai-factory
- **Layer:** backend
