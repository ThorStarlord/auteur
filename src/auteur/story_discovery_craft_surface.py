    ...
    if analysis.status != "complete":
        lines.extend(
            [
                "",
                "Craft tradeoffs",
                "- Detailed craft-impact explanation was unavailable for this run; no downstream craft claims were invented.",
            ]
        )
        return lines
...
def append_craft_comparison(
    ...
    """Append the full teaching explanation, or an explicit unavailable state."""
    ...
    if analysis.status != "complete":
        lines.extend(
            [
                "",
                "Detailed craft-impact analysis was unavailable for this run. No scene, emotion, theme, or composability claims were invented to fill the gap.",
                "",
            ]
        )
    else:
