"""Operational preparation and evidence recording for blinded V1.1 R7."""
...
RUN_ID = "20260830-qualified-agent-native-v11-r7"
RUN = DOCS / "runs" / RUN_ID
JOURNAL_ROOT = RUN / "transport"
CANARY_ROOT = RUN / "canary-transport"
MAP_PATH = Path(r"C:\Users\Admin\AppData\Local\Temp\v11-r7-condition-map-readable.json")
SALT_PATH = Path(r"C:\Users\Admin\AppData\Local\Temp\v11-r7-condition-map-salt.txt")
