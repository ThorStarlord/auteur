...
- Any architecture rule from `CLAUDE.md` that this work touches
...
- Do not summarize `CLAUDE.md` back to the orchestrator — it's already in their context.
