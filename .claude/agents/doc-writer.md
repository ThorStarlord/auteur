---
name: doc-writer
description: Writes CHANGELOG entries, README updates, migration guides for breaking changes. Scoped to docs paths only.
...
hooks:
  PreToolUse:
    - matcher: "Write|Edit|MultiEdit|NotebookEdit"
      hooks:
        - type: command
          command: 'node "$CLAUDE_PROJECT_DIR/.claude/hooks/factory-guard.mjs" doc-writer'
---
...
Authoritative scope: `CLAUDE.md` → "Path scoping for agents" → "Doc Writer may edit". Common entries:
