---
description: Full 12-agent chain for substantive new features. Use when the work touches multiple layers, changes schema, adds API contracts, or is otherwise non-trivial. Includes three human checkpoints (story approval, brief approval, PR review).
---
