---
description: Research-only chain. Use when the user asks "how does X work", "where is Y handled", or otherwise wants understanding before deciding to build. Runs the researcher agent only and returns findings — no code is written.
---
