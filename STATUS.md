...
The semantic foundation is merged, but the root decision-oriented Tutor workflow is **not yet complete on `main`**.
...
| [#177 / 0006 — Safe Tutor advisory sessions](https://github.com/ThorStarlord/auteur/issues/177) | ⬜ Open | Add local atomic session persistence, source fingerprints, stale detection, and advisory responses. |
| [#178 / 0007 — Root Tutor workflow](https://github.com/ThorStarlord/auteur/issues/178) | ⬜ Open | Add `auteur tutor next/show/explain/choose` over the merged card/session contracts. |
...
| [#180 / 0009 — Decision-Oriented Tutor docs](https://github.com/ThorStarlord/auteur/issues/180) | ⬜ Open | Document the actual merged root workflow after 0006–0008 exist. |

### Required ordering

Implement the remaining milestone in dependency order:
...
**Implement #177 / M1 0006 — safe Tutor advisory sessions.**

Why this is first:

1. Decision Cards already exist.
2. The root Tutor CLI depends on safe persisted session/currentness semantics.
