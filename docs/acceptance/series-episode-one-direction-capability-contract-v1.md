...
Status: ratified normative contract. This document was approved before
implementation, as accepted design authority for implementation planning.
Implementation and qualification status are tracked separately from this
normative contract; this document is not itself a claim that the capability
is qualified, released, or shipped.
